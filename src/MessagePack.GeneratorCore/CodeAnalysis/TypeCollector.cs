...
#pragma warning restore SA1401 // Fields should be private
        ...
        public ReferenceSymbols(Compilation compilation, Action<string> logger)
        {
            ...
            MessagePackObjectAttribute = compilation.GetTypeByMetadataName("Phoesion.MsgPack.MessagePackObjectAttribute");
            if (MessagePackObjectAttribute == null)
            {
                throw new InvalidOperationException("failed to get metadata of Phoesion.MsgPack.MessagePackObjectAttribute");
            }

            UnionAttribute = compilation.GetTypeByMetadataName("Phoesion.MsgPack.UnionAttribute");
            if (UnionAttribute == null)
            {
                throw new InvalidOperationException("failed to get metadata of Phoesion.MsgPack.UnionAttribute");
            }

            SerializationConstructorAttribute = compilation.GetTypeByMetadataName("Phoesion.MsgPack.SerializationConstructorAttribute");
            if (SerializationConstructorAttribute == null)
            {
                throw new InvalidOperationException("failed to get metadata of Phoesion.MsgPack.SerializationConstructorAttribute");
            }

            KeyAttribute = compilation.GetTypeByMetadataName("Phoesion.MsgPack.KeyAttribute");
            if (KeyAttribute == null)
            {
                throw new InvalidOperationException("failed to get metadata of Phoesion.MsgPack.KeyAttribute");
            }

            IgnoreAttribute = compilation.GetTypeByMetadataName("Phoesion.MsgPack.IgnoreMemberAttribute");
            if (IgnoreAttribute == null)
            {
                throw new InvalidOperationException("failed to get metadata of Phoesion.MsgPack.IgnoreMemberAttribute");
            }
            ...
            IMessagePackSerializationCallbackReceiver = compilation.GetTypeByMetadataName("Phoesion.MsgPack.IMessagePackSerializationCallbackReceiver");
            if (IMessagePackSerializationCallbackReceiver == null)
            {
                throw new InvalidOperationException("failed to get metadata of Phoesion.MsgPack.IMessagePackSerializationCallbackReceiver");
            }

            MessagePackFormatterAttribute = compilation.GetTypeByMetadataName("Phoesion.MsgPack.MessagePackFormatterAttribute");
            if (MessagePackFormatterAttribute == null)
            {
                throw new InvalidOperationException("failed to get metadata of Phoesion.MsgPack.MessagePackFormatterAttribute");
            }
        }
    }
